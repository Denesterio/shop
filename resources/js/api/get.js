...
// const getCategories = (_, params = {}) => {
//   const url = new URL('http://localhost:8000/api/categories');
...
//   return axios.get('/api/subcategories').then(({ data }) => data);
// };
...
// const getAuthors = () => {
//   return axios.get('/api/authors').then(({ data }) => data);
// };

// const getTags = () => {
//   return axios.get('/api/tags').then(({ data }) => data);
// };
